 ...
 *
 * File Name: intro.php
 * 	File containing the login page - shiny theme.
 *
 * File Author:
 * 		asrael...
 *
...
?></select></td>
	...
	<td align="center"><input type="submit" value="<?php print $lang["login"]; ?>" class="NFButton"></td>
	<td align="center"><?php if ($database->getinfo('miniui')) { echo '<input type="submit" name="shell_miniui" value="MiniUI" class="NFButton">'; }?></td>
</tr>
</table>
</td></tr>
</table>
